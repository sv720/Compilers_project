...
#line 127 "src/maths_parser.tab.cpp"
...
{
  "$end", "error", "$undefined", "T_INT", "T_VOID", "T_IDENTIFIER",
  "T_RETURN", "T_NUMBER", "T_VARIABLE", "MUL_ASSIGN", "DIV_ASSIGN",
  "MOD_ASSIGN", "ADD_ASSIGN", "SUB_ASSIGN", "LEFTSHIFT_ASSIGN",
  "RIGHTSHIFT_ASSIGN", "AND_ASSIGN", "XOR_ASSIGN", "OR_ASSIGN", "INC_OP",
  "DEC_OP", "LEFTSHIFT_OP", "RIGHTSHIFT_OP", "LE_OP", "GE_OP", "EQ_OP",
  "NE_OP", "AND_OP", "OR_OP", "PTR_OP", "T_TIMES", "T_DIVIDE", "T_PLUS",
  "T_MINUS", "'{'", "'}'", "'('", "')'", "';'", "'='", "'+'", "'-'", "'*'",
  "'/'", "$accept", "ROOT", "TOPLEVEL", "FUNCTION_NAME_ARGS",
  "STATEMENT_LINES", "LINE", "STATEMENT", "ASSIGN_DECLARE", "ASSIGN",
  "assignment_operator", "TYPE", "MATHS_STATEMENT", "TERM", "UNARY",
  "FACTOR", YY_NULLPTR
};
#endif
